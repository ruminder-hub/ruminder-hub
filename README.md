...
- 👯 Recently I have started writing articles on technologies (mostly used in creating backend of the application),  their concepts, how to use in the application and issues which can come while using them. The link for the blog can be found <a href="https://web.cs.dal.ca/~ruminder/" target="_blank">here</a>
